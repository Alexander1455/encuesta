const Footer = () => {
  return (
    <footer className=" bg-gray-800 text-white p-4 w-full z-50">
      <div className="container mx-auto flex items-center justify-between">
        ...
        <div className="py-10">
          ...
          <ul>
            ...
            <li>
              <a href="#" className="hover:text-blue-500 hover:underline">Services</a>
            </li>
            <li>
              <a href="#" className="hover:text-blue-500 hover:underline">Terms of service</a>
            </li>
            <li>
              <a href="#" className="hover:text-blue-500 hover:underline">Privacy policy</a>
            </li>
          </ul>
        </div>
        ...
        <div className="flex flex-col items-end">
          <h4 className="font-bold text-lg text-left">Contact</h4>
          <p className="text-sm">¡Contáctanos para hacer cosas increíbles juntos!</p>

          {/* Logos de redes sociales */}
          <div className="flex space-x-2 mt-2">
            <button className="bg-blue-400 p-2 font-semibold text-white rounded">
              <svg className="w-5 h-5 fill-current" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                <path d="M23.953 4.57a10 10 0 01-2.825.775 4.958 4.958 0 002.163-2.723c-.951.555-2.005.959-3.127 1.184a4.92 4.92 0 00-8.384 4.482C7.69 8.095 4.067 6.13 1.64 3.162a4.822 4.822 0 00-.666 2.475c0 1.71.87 3.213 2.188 4.096a4.904 4.904 0 01-2.228-.616v.06a4.923 4.923 0 003.946 4.827 4.996 4.996 0 01-2.212.085 4.936 4.936 0 004.604 3.417 9.867 9.867 0 01-6.102 2.105c-.39 0-.779-.023-1.17-.067a13.995 13.995 0 007.557 2.209c9.053 0 13.998-7.496 13.998-13.985 0-.21 0-.42-.015-.63A9.935 9.935 0 0024 4.59z" />
              </svg>
            </button>

            <button className="bg-blue-600 p-2 font-semibold text-white rounded">
              <svg className="w-5 h-5 fill-current" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 256">
            ...
            <button className="bg-gray-700 p-2 font-semibold text-white rounded">
              <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" aria-hidden="true" role="img" className="w-5" preserveAspectRatio="xMidYMid meet" viewBox="0 0 24 24">
            ...
            <button className="bg-red-500 p-2 font-semibold text-white rounded">
